...
class LocalizationString {
  ...
  static String walkthrough1 = 'We provide professional taxi services for you'.tr;
  static String walkthrough2 = 'Your satisfaction is our number one priority'.tr;
  static String walkthrough3 = "Let's make your day great with Taxio right now!".tr;

  static String letsYouIn = "Let’s you in".tr;
  static String facebookLogin = "Continue with Facebook".tr;
  static String googleLogin = "Continue with Google".tr;
  static String appleLogin = "Continue with Apple".tr;
  static String or = "or".tr;
  static String signWithPassword = "Sign in with password".tr;
  static String noAccount = "Don't have an account?".tr;
  static String signup = "Sign up".tr;

  static String loginTo = "Login to your Account".tr;
  ...
  static String orContinue = "or continue with".tr;

  static String createAccount = "Create your Account".tr;
  static String alreadyAccount = "Already have an account?".tr;

  static String fillProfile = "Fill Your Profile".tr;
  ...
  static String phone = "Phone Number".tr;
  static String continueStr = 'Continue'.tr;

  static String createNewPin = "Create New PIN".tr;
  static String createNewPinInfo = "Add a PIN number to make your account more secure.".tr;
